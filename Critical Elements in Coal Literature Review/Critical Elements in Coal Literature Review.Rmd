...
$$ \begin{equation}\tag{1} C_{Outlook}=\frac{\sum{C_{Vital}}}{\sum{C_{Excessive}}} \end{equation} $$
$$ \begin{equation}\tag{2} C_{\text{Critical percent}}=\frac{\sum{C_{Vital}}}{\sum{C_{REE}}} \end{equation} $$
