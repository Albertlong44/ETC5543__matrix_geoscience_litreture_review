...
In an ideal state, any chemical elements can be detected in coal
deposit, which may originate from syn-genetic plant decays or epigenetic
source after . Its concentration will be determined on coalified
compaction and the heat \& pressure environment.
